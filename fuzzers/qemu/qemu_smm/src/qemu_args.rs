...
pub fn gen_ovmf_qemu_args() -> Vec<String>
{
    vec![
        ...
        "-drive".to_string(),
        "if=pflash,format=raw,unit=0,file=/home/w/hd/uefi_fuzz/fuzzer/edk2/Build/OvmfX64/DEBUG_GCC5/FV/OVMF_CODE.fd,readonly=on".to_string(),
        "-drive".to_string(),
        "if=pflash,format=raw,unit=1,file=/home/w/hd/uefi_fuzz/fuzzer/edk2/Build/OvmfX64/DEBUG_GCC5/FV/OVMF_VARS.fd".to_string(),
        "-hda".to_string(),
