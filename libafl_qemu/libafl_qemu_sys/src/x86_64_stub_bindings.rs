...
fn bindgen_test_layout_SysemuCPUOps() {
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).get_paging_id) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(SysemuCPUOps),
            "::",
            stringify!(get_paging_id)
        )
    );
    assert_eq!(
...
#[test]
fn bindgen_test_layout_QEMUIOVector__bindgen_ty_1__bindgen_ty_1() {
    const UNINIT: ::std::mem::MaybeUninit<QEMUIOVector__bindgen_ty_1__bindgen_ty_1> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<QEMUIOVector__bindgen_ty_1__bindgen_ty_1>(),
        24usize,
        concat!(
            "Size of: ",
            stringify!(QEMUIOVector__bindgen_ty_1__bindgen_ty_1)
        )
    );
    assert_eq!(
        ::std::mem::align_of::<QEMUIOVector__bindgen_ty_1__bindgen_ty_1>(),
        8usize,
        concat!(
            "Alignment of ",
            stringify!(QEMUIOVector__bindgen_ty_1__bindgen_ty_1)
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).local_iov) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(QEMUIOVector__bindgen_ty_1__bindgen_ty_1),
...
#[test]
fn bindgen_test_layout_QEMUIOVector__bindgen_ty_1__bindgen_ty_2() {
    const UNINIT: ::std::mem::MaybeUninit<QEMUIOVector__bindgen_ty_1__bindgen_ty_2> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<QEMUIOVector__bindgen_ty_1__bindgen_ty_2>(),
        24usize,
        concat!(
            "Size of: ",
            stringify!(QEMUIOVector__bindgen_ty_1__bindgen_ty_2)
        )
    );
    assert_eq!(
        ::std::mem::align_of::<QEMUIOVector__bindgen_ty_1__bindgen_ty_2>(),
        8usize,
        concat!(
            "Alignment of ",
            stringify!(QEMUIOVector__bindgen_ty_1__bindgen_ty_2)
...
#[test]
fn bindgen_test_layout_QEMUIOVector__bindgen_ty_1() {
    assert_eq!(
        ::std::mem::size_of::<QEMUIOVector__bindgen_ty_1>(),
        24usize,
        concat!("Size of: ", stringify!(QEMUIOVector__bindgen_ty_1))
    );
    assert_eq!(
        ::std::mem::align_of::<QEMUIOVector__bindgen_ty_1>(),
        8usize,
        concat!("Alignment of ", stringify!(QEMUIOVector__bindgen_ty_1))
    );
}
...
#[test]
fn bindgen_test_layout_QEMUIOVector() {
    const UNINIT: ::std::mem::MaybeUninit<QEMUIOVector> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<QEMUIOVector>(),
        40usize,
        concat!("Size of: ", stringify!(QEMUIOVector))
    );
    assert_eq!(
        ::std::mem::align_of::<QEMUIOVector>(),
        8usize,
        concat!("Alignment of ", stringify!(QEMUIOVector))
    );
    assert_eq!(
        ...
        concat!(
            "Offset of field: ",
            stringify!(QEMUIOVector),
            "::",
            stringify!(iov)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).niov) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(QEMUIOVector),
...
#[test]
fn bindgen_test_layout_SyxCowCacheDevice() {
    const UNINIT: ::std::mem::MaybeUninit<SyxCowCacheDevice> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<SyxCowCacheDevice>(),
        16usize,
        concat!("Size of: ", stringify!(SyxCowCacheDevice))
    );
    assert_eq!(
        ::std::mem::align_of::<SyxCowCacheDevice>(),
        8usize,
        concat!("Alignment of ", stringify!(SyxCowCacheDevice))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).data) as usize - ptr as usize },
        0usize,
...
#[test]
fn bindgen_test_layout_SyxCowCacheLayer__bindgen_ty_1() {
    const UNINIT: ::std::mem::MaybeUninit<SyxCowCacheLayer__bindgen_ty_1> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<SyxCowCacheLayer__bindgen_ty_1>(),
        16usize,
        concat!("Size of: ", stringify!(SyxCowCacheLayer__bindgen_ty_1))
    );
    assert_eq!(
        ::std::mem::align_of::<SyxCowCacheLayer__bindgen_ty_1>(),
        8usize,
        concat!("Alignment of ", stringify!(SyxCowCacheLayer__bindgen_ty_1))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).tqe_next) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(SyxCowCacheLayer__bindgen_ty_1),
            "::",
            stringify!(tqe_next)
        )
    );
...
#[test]
fn bindgen_test_layout_SyxCowCacheLayer() {
    const UNINIT: ::std::mem::MaybeUninit<SyxCowCacheLayer> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<SyxCowCacheLayer>(),
        40usize,
        concat!("Size of: ", stringify!(SyxCowCacheLayer))
    );
    assert_eq!(
        ::std::mem::align_of::<SyxCowCacheLayer>(),
        8usize,
        concat!("Alignment of ", stringify!(SyxCowCacheLayer))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).cow_cache_devices) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(SyxCowCacheLayer),
            "::",
            stringify!(cow_cache_devices)
        )
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).max_nb_chunks) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(SyxCowCacheLayer),
            "::",
            stringify!(max_nb_chunks)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).next) as usize - ptr as usize },
...
#[test]
fn bindgen_test_layout_SyxCowCache__bindgen_ty_1() {
    const UNINIT: ::std::mem::MaybeUninit<SyxCowCache__bindgen_ty_1> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<SyxCowCache__bindgen_ty_1>(),
        16usize,
        concat!("Size of: ", stringify!(SyxCowCache__bindgen_ty_1))
    );
    assert_eq!(
        ::std::mem::align_of::<SyxCowCache__bindgen_ty_1>(),
        8usize,
        concat!("Alignment of ", stringify!(SyxCowCache__bindgen_ty_1))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).tqh_first) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(SyxCowCache__bindgen_ty_1),
            "::",
            stringify!(tqh_first)
        )
    );
...
#[test]
fn bindgen_test_layout_SyxCowCache() {
    const UNINIT: ::std::mem::MaybeUninit<SyxCowCache> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<SyxCowCache>(),
        16usize,
        concat!("Size of: ", stringify!(SyxCowCache))
    );
    assert_eq!(
        ::std::mem::align_of::<SyxCowCache>(),
        8usize,
        concat!("Alignment of ", stringify!(SyxCowCache))
    );
    assert_eq!(
...
#[test]
fn bindgen_test_layout_SyxSnapshot() {
    const UNINIT: ::std::mem::MaybeUninit<SyxSnapshot> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<SyxSnapshot>(),
        32usize,
        concat!("Size of: ", stringify!(SyxSnapshot))
    );
    assert_eq!(
        ::std::mem::align_of::<SyxSnapshot>(),
        8usize,
        concat!("Alignment of ", stringify!(SyxSnapshot))
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).bdrvs_cow_cache) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(SyxSnapshot),
            "::",
            stringify!(bdrvs_cow_cache)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).rbs_dirty_list) as usize - ptr as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(SyxSnapshot),
            "::",
            stringify!(rbs_dirty_list)
        )
    );
}
...
#[test]
fn bindgen_test_layout_SyxSnapshotTracker() {
    const UNINIT: ::std::mem::MaybeUninit<SyxSnapshotTracker> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<SyxSnapshotTracker>(),
        24usize,
        concat!("Size of: ", stringify!(SyxSnapshotTracker))
    );
    assert_eq!(
        ::std::mem::align_of::<SyxSnapshotTracker>(),
        8usize,
        concat!("Alignment of ", stringify!(SyxSnapshotTracker))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).tracked_snapshots) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(SyxSnapshotTracker),
            "::",
            stringify!(tracked_snapshots)
        )
    );
    assert_eq!(
...
#[test]
fn bindgen_test_layout_SyxSnapshotState() {
    const UNINIT: ::std::mem::MaybeUninit<SyxSnapshotState> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<SyxSnapshotState>(),
        64usize,
        concat!("Size of: ", stringify!(SyxSnapshotState))
    );
    assert_eq!(
        ::std::mem::align_of::<SyxSnapshotState>(),
        8usize,
        concat!("Alignment of ", stringify!(SyxSnapshotState))
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).page_mask) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(SyxSnapshotState),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).before_fuzz_cache) as usize - ptr as usize },
        48usize,
        concat!(
            "Offset of field: ",
            stringify!(SyxSnapshotState),
            "::",
            stringify!(before_fuzz_cache)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).active_bdrv_cache_snapshot) as usize - ptr as usize },
        56usize,
        concat!(
            "Offset of field: ",
            stringify!(SyxSnapshotState),
            "::",
            stringify!(active_bdrv_cache_snapshot)
        )
    );
}
...
#[test]
fn bindgen_test_layout_SyxSnapshotCheckResult() {
    const UNINIT: ::std::mem::MaybeUninit<SyxSnapshotCheckResult> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<SyxSnapshotCheckResult>(),
        8usize,
        concat!("Size of: ", stringify!(SyxSnapshotCheckResult))
    );
    assert_eq!(
        ::std::mem::align_of::<SyxSnapshotCheckResult>(),
        8usize,
        concat!("Alignment of ", stringify!(SyxSnapshotCheckResult))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).nb_inconsistencies) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(SyxSnapshotCheckResult),
            "::",
            stringify!(nb_inconsistencies)
        )
    );
}
extern "C" {
...
fn bindgen_test_layout_MemoryRegionSection() {
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).unmergeable) as usize - ptr as usize },
        50usize,
        concat!(
            "Offset of field: ",
            stringify!(MemoryRegionSection),
...
fn bindgen_test_layout_AddressSpace() {
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ioeventfd_notifiers) as usize - ptr as usize },
        44usize,
        concat!(
            "Offset of field: ",
            stringify!(AddressSpace),
...
impl ::std::fmt::Debug for AddressSpace {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        write ! (f , "AddressSpace {{ rcu: {:?}, name: {:?}, root: {:?}, current_map: {:?}, ioeventfd_nb: {:?}, ioeventfd_notifiers: {:?}, ioeventfds: {:?}, listeners: {:?}, address_spaces_link: {:?} }}" , self . rcu , self . name , self . root , self . current_map , self . ioeventfd_nb , self . ioeventfd_notifiers , self . ioeventfds , self . listeners , self . address_spaces_link)
    }
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
fn bindgen_test_layout_TranslationBlock() {
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).page_next) as usize - ptr as usize },
        48usize,
        concat!(
            "Offset of field: ",
            stringify!(TranslationBlock),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).page_addr) as usize - ptr as usize },
        64usize,
        concat!(
            "Offset of field: ",
            stringify!(TranslationBlock),
...
extern "C" {
    pub fn libafl_get_first_cpu() -> *mut CPUState;
}
extern "C" {
...
extern "C" {
    pub fn libafl_add_post_devicereg_read_hook(
        callback: ::std::option::Option<
            unsafe extern "C" fn(
                data: u64,
                device_base: target_ulong,
...
extern "C" {
    pub fn libafl_qemu_remove_post_devicereg_read_hook(
        num: usize,
        invalidate: ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn libafl_add_pre_devicereg_write_hook(
        callback: ::std::option::Option<
            unsafe extern "C" fn(
                data: u64,
                device_base: target_ulong,
